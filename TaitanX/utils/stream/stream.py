...
from TaitanX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from TaitanX.utils.exceptions import AssistantErr
from TaitanX.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from TaitanX.utils.inline.playlist import close_markup
from TaitanX.utils.pastebin import TaitanXbin
from TaitanX.utils.stream.queue import put_queue, put_queue_index
from TaitanX.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await TaitanX.force_stop_stream(chat_id)
