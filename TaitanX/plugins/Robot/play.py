...
from TaitanX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
...
from TaitanX.utils.database import is_video_allowed
...
from TaitanX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from TaitanX.utils.database import is_served_user
from TaitanX.utils.inline.playlist import botplaylist_markup
...
@app.on_callback_query(
    filters.regex("TaitanXymousAdmin") & ~BANNED_USERS
)
async def TaitanXymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("TaitanXPlaylists") & ~BANNED_USERS
)
@languageCB
